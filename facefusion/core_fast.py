...
def conditional_process() -> None:
	...
	# ============= BUG do not support video ===================
	# print("start frame processer")
	# for frame_processor_module in get_frame_processors_modules(facefusion.globals.frame_processors):
	...
	if os.path.isdir(facefusion.globals.target_path):
		process_image_folder(facefusion.globals.target_path)
...
def process_image_folder(target_folder: str) -> None:
	# get all image in the parth
    image_formats = ("jpg", "jpeg", "png", "gif", "JPG", "JPEG", "PNG",)
    image_paths = []
...
def process_video(start_time : float) -> None:
	...
	# if don't allow unsafe for work (NSFW)
	# if analyse_video(facefusion.globals.target_path, facefusion.globals.trim_frame_start, facefusion.globals.trim_frame_end):
	# 	return
	
	# otherwise, allow unsafe for work 
